...
export default function DvtBadge() {
	...
	const dvtStyle = {
		...
		top: '50%',
		left: 0,
		color: 'var(--colLightAndDark)',
		zIndex: 999,
		backgroundColor: 'var(--colDarkAndLight)', // Replace with actual color of --colDarkAndLight
		...
		border: '1px solid var(--colLightAndDark)',
		borderRight: 'none',
		textDecoration: 'none',
	};
	const dvtLineTop = {
		...
		top: 0,
		left: '9px',
		backgroundColor: 'var(--colLightAndDark)',
